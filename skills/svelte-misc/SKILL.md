...
- [svelte:element and {#key} blocks](./examples/dynamic-components.md) - Dynamic tag switching, component remounting, transitions

### Debug and HTML

- [@html, @debug, @const](./examples/debug-html.md) - Raw HTML rendering, debugging, template constants

### TypeScript

- [TypeScript with Svelte 5](./examples/typescript.md) - Typed props, generics, event handlers, component refs
...
- [svelte:element vs svelte:component](./references/dynamic-reference.md#svelteelement) - When to use each
- [{#key} behavior](./references/dynamic-reference.md#key-block) - Remounting and use cases
- [{@html} security](./references/dynamic-reference.md#html) - Security model and sanitization
- [{@debug} triggers](./references/dynamic-reference.md#debug) - When debug output fires
- [{@const} usage](./references/dynamic-reference.md#const) - Template constant patterns

### TypeScript Reference

- [$props type inference](./references/typescript-reference.md#props-type-inference) - Typed props
- [Snippet type](./references/typescript-reference.md#snippet-type-signature) - Snippet function signatures
- [Event types](./references/typescript-reference.md#event-types) - DOM event type mappings
- [Component types](./references/typescript-reference.md#component-types) - Component type utilities
- [Generics](./references/typescript-reference.md#generic-components) - Generic component syntax
