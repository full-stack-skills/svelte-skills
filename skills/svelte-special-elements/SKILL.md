...
| File | Description |
|------|-------------|
| [examples/svelte-element-examples.md](./examples/svelte-element-examples.md) | Comprehensive examples covering `svelte:window`, `svelte:document`, `svelte:body`, `svelte:element`, `svelte:component`, `svelte:self`, `svelte:options` |
...
- **svelte:element**: Dynamic heading levels (h1-h6), conditional tags
...
| File | Description |
|------|-------------|
| [references/svelte-element-reference.md](./references/svelte-element-reference.md) | Complete reference for `svelte:window`, `svelte:document`, `svelte:body`, `svelte:element`, `svelte:component` with all supported events and bindings |
| [references/svelte-options-reference.md](./references/svelte-options-reference.md) | Complete reference for `svelte:options` covering `customElement`, `runes`, `namespace`, `css`, `preserveComments`, and all compiler options |
